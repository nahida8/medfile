    ...
    _createClass(Accordion, [
      {
        ...
        value: function init() {
          ...
          var openedIndexes =
            self.options.defaultOpenedIndexes instanceof Array
              ? self.options.defaultOpenedIndexes
              : [self.options.defaultOpenedIndexes];

          var _loop = function _loop(i) {
            var accordionItem = self.accordion.children[i];
            var accordionItemHeading = accordionItem.getElementsByClassName(
              "accordion-heading"
            )[0];
            ...
            if (accordionItemHeading) {
              ...
              if (accordionItemHeading.eventListenerAttached !== true) {
                accordionItemHeading.addEventListener(
      ...
      },
      {
        ...
        value: function openAccordionItem(item, itemIndex) {
          ...
          var accordionItemContent = item.getElementsByClassName(
            "accordion-content"
          )[0];
